...
const lgas = {
  'Abia': ['Aba North', 'Aba South', 'Arochukwu', 'Bende', 'Ikwerre', 'Ikwuano', 'Isiala-Ngwa North', 'Isiala-Ngwa South', 'Isuikwuato', 'Obi Ngwa', 'Ohafia', 'Osisioma Ngwa', 'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South', 'Umu-Neochi'],
...
module.exports = { states, lgas, specializations, hospitalDepartments };
