...
exports.approveUser = async (req, res, next) => {
  try {
    ...
    await createNotification({ recipient: user._id, title: 'Account Approved', message: 'Your account has been approved. Welcome to VOA System!', type: 'general' });
...
exports.updateMyProfile = async (req, res, next) => {
  try {
    const allowed = ['fullName', 'phone', 'bio', 'state', 'address', 'emergencyContact'];
    const updates = {};
    allowed.forEach((f) => { if (req.body[f] !== undefined) updates[f] = req.body[f]; });
